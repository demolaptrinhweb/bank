...
$truyendulieu = "";
    if (isset($_GET['search'])) {
        ...
        if ($by == "name") {
            $sql0 = "SELECT id,theme,title FROM news
...
<body>
            ...
            <div class="flex-item-search-bar" id="fi-search-bar">
                ...
                <form class="search_form" action="" method="get">
                    <div class="flex-item-search">
                        <input name="search" size="30" type="text" placeholder="tìm kiếm post" />
                    </div>
                    ...
                    <div class="flex-item-search-by">
                        <select name="by">
                            <option value="name">theme</option>
 ...
 <div class="flex-container">
  ...
  <p align="center"> trang : <?php  if ($page != 1  ){
	  ?>
      <a href="post_news_manager.php?page=<?php echo 1 ; echo $truyendulieu;?>"> << </a>
  ...
  for($i=$dau;$i<=$cuoi;$i++){
	     if ($page == $i) echo " <b> <i> $i </i> </b> &nbsp;";
	       ...
	       <a href="post_news_manager.php?page=<?php echo $i ; echo $truyendulieu;?> "><?php echo $i ; ?> &nbsp;</a>
